...
import { Plus, Minus, AlertTriangle, X, Trash2, ShoppingCart } from "lucide-react";
...
export default function Stock() {
  ...
  async function confirmerVente() {
    ...
    try {
      ...
      // 2. Crée l'enregistrement de vente
      ...
      // 3. Crée automatiquement la transaction revenu liée
